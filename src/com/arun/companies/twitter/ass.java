...
public class Solution {
    ...
    private static List requstList = new ArrayList<>();
    private static List outputEntities = new ArrayList<>();
    ...
    private static MyDate createDateFromString(String str) {
        ...
        if (2 == splitStr.length) {
            ...
            date = new MyDate(Integer.parseInt(splitStr[0].trim()), Integer.parseInt(splitStr[1].trim()), Integer.parseInt(splitStr[2].trim()));
        }
        return date;
    }
